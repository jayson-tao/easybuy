...
<div class="header-top">
			<div class="header-box">
				...
				<font id="login-info" class="login-info SZY-USER-NOT-LOGIN">
					<a class="login color" href="/client/login" target="_top">请登录</a>
					<a class="register" href="/client/reg" target="_top">免费注册</a>
				</font>
				<font id="login-info" class="login-info SZY-USER-ALREADY-LOGIN" style="display: none;">
					<em>
						<a href="http://127.0.0.1" target="_blank" class="color SZY-USER-NAME"></a>
						<!--欢迎您回来!-->
					</em>
				...
				<ul>
					...
					<li class="menu-item">
						<div class="menu">
							<a class="menu-hd myinfo" href="http://127.0.0.1" target="_blank">
								<i></i> 会员中心
								<b></b>
							</a>
							<div id="menu-2" class="menu-bd" style="display: none;">
								...
								<div class="menu-bd-panel">
									<a href="http://127.0.0.1/trade/order" target="_blank">我的宝贝</a>
									<a href="http://127.0.0.1/user/address" target="_blank">我的地址</a>
									<a href="http://127.0.0.1/trade/collect" target="_blank">我的收藏</a>
					...
					<li class="menu-item cartbox">
						<div class="menu">
							<a class="menu-hd cart" href="/cart/index" target="_top">
								<i></i> 购物车
