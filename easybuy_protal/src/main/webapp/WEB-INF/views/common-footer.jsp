...
<!-- 底部 _start-->
		...
		<div class="site-footer">
			...
			<div class="footer-service">
				<div align="center"><img src="/static/img/test/14778844965714.jpg" alt="" height="85" width="1210"></div>
			</div>
			...
			<div class="footer-related">
				...
				<div class="footer-article w1210">
					<dl class="col-article col-article-spe">
						<dt class="phone color">028-86261949</dt>
						<dd class="email color">master@yaorange.cn</dd>
					...
					<dl class="col-article col-article-first">
						...
						<dd>
							...
							<a rel="nofollow" href="#" target="_blank">订单查询</a>
						...
						<dd>
							...
							<a rel="nofollow" href="#" target="_blank">在线客服</a>
					...
					<dl class="col-article col-article-first">
						...
						<dd>
							...
							<a rel="nofollow" href="#" target="_blank">网上支付</a>
					...
					<dl class="col-article col-article-first">
						...
						<dd>
							...
							<a rel="nofollow" href="#" target="_blank">配送范围及收费标准</a>

						</dd>

						<dd>

							<a rel="nofollow" href="#" target="_blank">订单进度查询</a>

						</dd>

						<dd>

							<a rel="nofollow" href="#" target="_blank">验货与签收</a>
			...
			<div class="footer-desc-copyright">
				...
				<p class="footer-ecscinfo">
					...
					|
					<a rel="nofollow" target="_blank" href="http://bbs.yaorange.cn/">会员论坛</a>
					|
					<a href="javascript:;" rel="nofollow">客服热线028-86261949</a>
				</p>
				<p class="footer-otherlink">
					<a title="易购商城" target="_blank" href="http://yaorange.cn">易购商城</a>

					|


					<a title="菁鱼课堂" target="_blank" href="http://www.yaorange.cn">菁鱼课堂</a>

					|

					<a title="资讯速递" target="_blank" href="http://www.yaorange.cn">资讯速递</a>
					...
					<a title="论坛" target="_blank" href="http://bbs.yaorange.com/forum.php">会员论坛</a>

					|

					<a title="易购网" target="_blank" href="http://www.yaorange.cn">易购网</a>
				...
				<p class="footer-Copyright">Copyright &copy; 2017
					<a target="_blank" style="margin:0;padding:0;" href="http://www.yaorange.cn/">yaorange.cn</a> All Rights Reserved. </p>
				<p>&nbsp;</p>
